...
if __name__ == '__main__':
        page=333
        file = open('ch_dance1101-1130.csv', 'a', encoding='utf-8', newline='')
        # 先设置列名，并写入csv文件
        ...
        for p in range(page):
            p=p+1
            url="https://s.search.bilibili.com/cate/search?main_ver=v3&search_type=video&view_type=hot_rank&copy_right=-1&new_web_tag=1&order=click&cate_id=200&page={}&pagesize=30&time_from=20211101&time_to=20211231".format(p)
            # print(url)
