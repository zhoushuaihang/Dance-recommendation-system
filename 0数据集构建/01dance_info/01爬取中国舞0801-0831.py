# -*-coding:utf-8-*-
# 爬取B站中国舞视频20210801-20210830时间段视频
import requests
import re
import json
import csv
...
if __name__ == '__main__':
        ...
        #查看原网页，获取网页数值
        page = 151
        file = open('dance.csv', 'a', encoding='utf-8', newline='')#保存文件名
        # 先设置列名，并写入csv文件
        ...
        for p in range(page):
            p=p+1
            url="https://s.search.bilibili.com/cate/search?main_ver=v3&search_type=video&view_type=hot_rank&copy_right=-1&new_web_tag=1&order=click&cate_id=200&page={}&pagesize=30&time_from=20210801&time_to=20210831".format(p)
            # print(url)
